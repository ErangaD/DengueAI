...
features= features.drop('reanalysis_air_temp_k', axis = 1)
features= features.drop('reanalysis_max_air_temp_k', axis = 1)
features= features.drop('reanalysis_min_air_temp_k', axis = 1)
features= features.drop('reanalysis_precip_amt_kg_per_m2', axis = 1)
features= features.drop('precipitation_amt_mm', axis = 1)
features= features.drop('reanalysis_relative_humidity_percent', axis = 1)
features= features.drop('station_max_temp_c', axis = 1)
features= features.drop('station_min_temp_c', axis = 1)
features= features.drop('station_diur_temp_rng_c', axis = 1)
features= features.drop('station_precip_mm', axis = 1)
features= features.drop('reanalysis_dew_point_temp_k', axis = 1)
